...
if __name__ == "__main__":
    print("--- CENÁRIO 2: ROTEAMENTO DIRETO PARA O CHURN ---")
    SESSION_ID = "conversa-python-002"
    
    enviar_mensagem(SESSION_ID, "O motivo do cancelamento é o preço, está muito caro para mim.")